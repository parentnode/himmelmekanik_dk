/*
asset-builder @ 2023-09-18 19:55:28
*/
...
/*m-letter.js*/
Util.Modules["letter"] = new function() {
...
/*m-side_a.js*/
Util.Modules["side_a"] = new function() {
	this.init = function(div) {
		div.resized = function(event) {
			if(this.is_active) {
				if(this.canvas) {
...
/*m-side_b.js*/
Util.Modules["side_b"] = new function() {
	this.init = function(div) {
		div.resized = function(event) {
			if(this.is_active) {
				if(this.canvas) {
...
/*m-finale.js*/
Util.Modules["finale"] = new function() {
	this.init = function(div) {
		div.resized = function(event) {
			if(this.is_active) {
				u.a.translate(this.cloud_left_top, (page.browser_w / 4 - 150), 0);
...
/*m-cookies.js*/
Util.Modules["cookies"] = new function() {
	this.init = function(scene) {
		scene.resized = function() {
		}
		scene.scrolled = function() {
